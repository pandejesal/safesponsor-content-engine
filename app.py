...
from analyzer import analyze_transcript_local
...
def main():
    ...
    # Step 2: Analyze with Local Engine (no API required)
    print("\n[Step 2/5] Analyzing transcript with SafeSponsor AI...")
    analysis_result = analyze_transcript_local(transcript_data['transcript'])
    ...
    # Step 4: Generate SafeSponsor Reel (code-based, no API)
